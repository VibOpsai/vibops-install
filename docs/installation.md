...
- **Nothing downloaded is executed as code**, with one exception you choose:
  ...
  script, which Docker states is not for production use. Until v0.46.4 this
...
cosign verify \
  ...
  ghcr.io/davidmacamara-boop/vibops-core:v0.46.4
```
...
signed at `v0.46.4`. Those are every image the chart deploys that the rule
...
for image in \
  ghcr.io/davidmacamara-boop/vibops-core:v0.46.4 \
  ghcr.io/davidmacamara-boop/vibops-agent:v0.46.4 \
  ghcr.io/davidmacamara-boop/vibops-console:v0.46.4 \
  ghcr.io/davidmacamara-boop/vibops-worker:v0.46.4 \
  ghcr.io/davidmacamara-boop/vibops-llm-proxy:v0.46.4 \
  ghcr.io/davidmacamara-boop/vibops-connect:v0.46.4 \
...
> **On PostgreSQL.** Until v0.46.4 the chart pulled a Bitnami image that existed
...
| `--version` | latest release | Image tag to deploy, e.g. `v0.46.4` |
...
```bash
docker run --rm ghcr.io/davidmacamara-boop/vibops-core:v0.46.4 python -c \
