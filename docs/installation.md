...
cosign verify \
  ...
  ghcr.io/davidmacamara-boop/vibops-core:v0.47.1
```
...
for image in \
  ghcr.io/davidmacamara-boop/vibops-core:v0.47.1 \
  ghcr.io/davidmacamara-boop/vibops-agent:v0.47.1 \
  ghcr.io/davidmacamara-boop/vibops-console:v0.47.1 \
  ghcr.io/davidmacamara-boop/vibops-worker:v0.47.1 \
  ghcr.io/davidmacamara-boop/vibops-llm-proxy:v0.47.1 \
  ghcr.io/davidmacamara-boop/vibops-connect:v0.47.1 \
...
| `--version` | latest release | Image tag to deploy, e.g. `v0.47.1` |
...
```bash
docker run --rm ghcr.io/davidmacamara-boop/vibops-core:v0.47.1 python -c \
