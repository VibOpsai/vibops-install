...
cosign verify \
  ...
  ghcr.io/davidmacamara-boop/vibops-core:v0.46.6
```
...
for image in \
  ghcr.io/davidmacamara-boop/vibops-core:v0.46.6 \
  ghcr.io/davidmacamara-boop/vibops-agent:v0.46.6 \
  ghcr.io/davidmacamara-boop/vibops-console:v0.46.6 \
  ghcr.io/davidmacamara-boop/vibops-worker:v0.46.6 \
  ghcr.io/davidmacamara-boop/vibops-llm-proxy:v0.46.6 \
  ghcr.io/davidmacamara-boop/vibops-connect:v0.46.6 \
...
| `--version` | latest release | Image tag to deploy, e.g. `v0.46.6` |
...
```bash
docker run --rm ghcr.io/davidmacamara-boop/vibops-core:v0.46.6 python -c \
